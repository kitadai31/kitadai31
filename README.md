...
# ChMateのBANされた鍵を消す方法👉
- 初心者用  
PC不要。改造不要で完全ホワイト。APKの上書きによる鍵削除 「[monakey-remover-app](https://github.com/kitadai31/monakey-remover-app)」
- 上級者用  
  - apkに新しいファイルを追加するだけ 鍵を削除するための自作アクティビティをアプリに追加してリンクを踏んで起動する [こちら](https://github.com/kitadai31/monakey-remover)   
  - apkをｺﾞﾆｮｺﾞ[検閲削除]
